...
using ApiRestFull.Hypermedia.Constants;
...
namespace ApiRestFull.Hypermedia.Enricher
{
    ...
    public class PersonEnricher : ContentResponseEnricher<PessoaVO>
    {
        ...
        private string GetLink(long id, IUrlHelper urlHelper, string path)
        {
            lock (_lock)
            {
                ...
                var teste = new StringBuilder(urlHelper.Link("DefaultApi", url)).Replace("%2F", "/").ToString();
                return teste;
